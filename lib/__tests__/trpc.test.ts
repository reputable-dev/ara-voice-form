...
describe('trpc', () => {
  ...
  it('uses EXPO_PUBLIC_API_BASE_URL when available', () => {
  ...
  it('throws error when EXPO_PUBLIC_API_BASE_URL is not set', () => {
    ...
    expect(() => {
      require('../trpc');
    }).toThrow('No base url found, please set EXPO_PUBLIC_API_BASE_URL');
  });
