...
const styles = StyleSheet.create({
  ...
  hero: { gap: 10, backgroundColor: "rgba(0,0,0,0.45)" },
  h1: { color: "#F3F4F6", fontSize: 22, fontWeight: "700" },
  badge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  badgeText: { color: "#D1FAE5", fontStyle: "italic", fontSize: 13 },
  ...
  btnPrimaryText: { color: "#D1FAE5", fontSize: 12, fontWeight: "700" },
  answersWrap: { gap: 8 },
  msg: {
    borderWidth: 1,
    borderColor: "#1F2937",
  ...
  btnSmPrimaryText: { color: "#D1FAE5", fontSize: 12, fontWeight: "700" },
